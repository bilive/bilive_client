...
export class BiLive {
   ...
   */
  private Lottery() {
    const SLottery = new Lottery.Lottery()
    SLottery
   ...
   */
  private SmallTVHandler(userData: userData) {
   ...
   * @param {userData} userData
   */
  private LotteryHandler(userData: userData) {
   ...
   * @param {userData} userData
   */
  private CookieInfoHandler(userData: userData) {
...
export interface userData extends JSON {
  userName: string;
  email: string;
  status: boolean;
  cookie: string;
