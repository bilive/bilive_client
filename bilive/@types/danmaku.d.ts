...
interface SEND_GIFT_Data extends SEND_GIFT_Data_Base {
...
interface WELCOME_Data extends WELCOME_Data_Base {
  vip: number // 月费老爷
}
interface WELCOME_Data extends WELCOME_Data_Base {
  svip: number // 年费老爷
...
interface EVENT_CMD_Data extends danmuJson {
...
interface LIGHTEN_START_Data extends danmuJson {
  type: string // 活动标识
...
interface LIGHTEN_END_Data extends danmuJson {
  type: string // 活动标识
  lightenId: number // 参与id
}
/**
...
interface SPECIAL_GIFT_Data_BeatStorm extends SPECIAL_GIFT_Data_BeatStorm_Base {
  id: number // 参与id
  num: number // 节奏数量
  time: number // 节奏持续时间
  content: string // 节奏内容
...
interface TV_START_Data extends danmuJson {
  id: string // 小电视编号
  dtime: number // 持续时间
  msg: SYS_MSG
}
...
interface TV_END_Data extends danmuJson {
  id: number // 小电视编号
  uname: string // 中奖者
  sname: string // 赠送者
...
interface RAFFLE_START_Data extends danmuJson {
  raffleId: number // 编号
...
interface RAFFLE_END_Data extends danmuJson {
  raffleId: number // 编号
  raffleType: string // 文案
}
/**
...
interface DRAW_UPDATE_data extends danmuJson {
  x_min: number
  x_max: number
  y_min: number
  y_max: number
